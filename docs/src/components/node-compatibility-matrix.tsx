      ...
      <div className="shrink-0 border-b border-gray-alpha-400 bg-background-200 px-3 py-3 md:px-4">
        <div className="flex flex-col gap-3 xl:flex-row xl:items-center">
          <div className="min-w-fit">
            ...
            <p className="text-xs text-gray-800">Frontend/C inventory and QuickJS island · Node {snapshot.nodeVersion}</p>
            <p className="text-xs text-gray-800">Rust backend and V8/Boa support require separate verification; these statuses do not establish Rust compatibility.</p>
          </div>
