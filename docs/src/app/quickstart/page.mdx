...
- **Node ≥ 24** — to run the compiler. Generated executables need no Node.
- **Cargo and rustc** — for the default Rust native backend.
- **Native tools** — explicit C/LLVM builds use the compiler or helper/linker described in [platform support](/platforms). Source outputs require only Node.
