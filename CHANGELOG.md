...
- **Typed arrays and Buffer have a safe-Rust storage model.** Numeric element coercion, copying, shared views, slicing, bulk set, UTF-8/hex/base64 conversion, concatenation, fixed-width numeric access, and byte-exact synchronous filesystem I/O are differential-tested against Node.
