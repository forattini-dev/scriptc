// The embedded-module TABLES and their text: engine-neutral (both the
// boa and the V8 islands read them). The per-engine loaders live in
// island_modules.rs (boa) and v8_island.rs (V8).
