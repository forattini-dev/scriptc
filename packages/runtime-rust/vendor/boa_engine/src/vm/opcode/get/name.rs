...
impl GetNameGlobal {
    ...
    pub(crate) fn operation(
        ...
        if binding_locator.is_global() {
            ...
            // scriptc: see get/property.rs — a global getter that
            // redefines its own binding mid-call moves the global object
            // to another shape; the slot recorded describes the shape
            // before the call.
