...
> = {
  ...
  replace: { argTypes: [STRING, STRING], minArgs: 2, result: STRING },
  replaceAll: { argTypes: [STRING, STRING], minArgs: 2, result: STRING },
...
export const LIB_FN_SIGS: Record<IrLibFn, { argTypes: (IrType | null)[]; result: IrType }> = {
  ...
  "math.hypot": { argTypes: [F64, F64], result: F64 },
  ...
  "num.toRadixString": { argTypes: [F64, F64], result: STRING },
