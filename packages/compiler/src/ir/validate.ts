  ...
  function checkExpr(e: IrExpr): void {
    switch (e.kind) {
      ...
      case "libCall": {
        ...
        if (e.fn === "effect.runSync" || e.fn === "effect.runPromise" || e.fn === "effect.fn" || e.fn === "effect.exitValue") { // site-typed: the success channel (runSync/runPromise), the function value (fn)
