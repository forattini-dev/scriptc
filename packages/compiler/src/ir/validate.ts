  ...
  function checkExpr(e: IrExpr): void {
    switch (e.kind) {
      ...
      case "libCall": {
        ...
        if (e.fn === "effect.runSync" || e.fn === "effect.runPromise" || e.fn === "effect.fn" || e.fn === "effect.exitValue" || e.fn === "option.getOrUndefined" || e.fn === "option.getOrElse" || e.fn === "option.match" || e.fn.startsWith("schema.decode") || e.fn === "schema.is" || e.fn === "schema.encodeSync") { // site-typed: the success channel (runSync/runPromise), the function value (fn)
