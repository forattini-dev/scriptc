...
const LIB_FN_SYMS: Record<string, string> = {
  ...
  "num.toPrecision": "scr_num_to_precision",
  "num.toRadixString": "scr_num_to_radix_string",
  ...
  "crypto.hmacDigestStr": "scr_crypto_hmac_digest_str",
  "crypto.hmacDigestBytes": "scr_crypto_hmac_digest_bytes",
  ...
  "fs.writeFileExclusiveModeSync": "scr_fs_write_file_exclusive_mode",
  ...
  "http.serverMaxHeaderSizeSet": "scr_http_server_max_header_size_set",
