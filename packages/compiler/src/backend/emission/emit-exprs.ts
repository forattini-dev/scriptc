    ...
    switch (e.kind) {
      ...
      case "libCall": {
        ...
        switch (fn) {
          ...
          case "process.offUncaughtException": case "effect.succeed": case "effect.sync": case "effect.map": case "effect.flatMap": case "effect.runSync": case "effect.runPromise": case "effect.gen": case "effect.fail": case "effect.die": case "effect.orDie": case "effect.catchAll": case "effect.mapError": case "effect.promise": case "effect.tryPromise": case "effect.fn": case "effect.void": case "effect.as": case "effect.asVoid": case "effect.ignore": case "effect.andThenEffect": case "effect.serviceKey": case "effect.provide": case "effect.provideService": case "layer.empty": case "layer.succeed": case "layer.effect": case "layer.provide": case "layer.provideMerge": case "layer.merge": case "effect.forEach": case "effect.all":
