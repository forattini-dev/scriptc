...
test("Rust default Set parameters match Node", async () => {
  const fixture = resolve("tests/corpus/1550-param-defaults-func-set.ts");
  const dir = await mkdtemp(join(tmpdir(), "scriptc-rust-default-set-"));
