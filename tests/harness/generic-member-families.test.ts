...
test.for(["3259-generic-member-families.ts", "3261-generic-member-values.ts"])("generic member family %s retains Node behavior in engine-free Rust", async file => {
  const dir = mkdtempSync(join(tmpdir(), "scriptc-member-family-"));
  try {
