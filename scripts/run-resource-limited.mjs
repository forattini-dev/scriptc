...
const environment = {
  ...
  SCRIPTC_SAN: process.env.SCRIPTC_SAN,
  CARGO_TARGET_DIR: cargoTarget,
  SCRIPTC_TEST_WORKERS: process.env.SCRIPTC_TEST_WORKERS ?? "1",
  SCRIPTC_NATIVE_WORKERS: process.env.SCRIPTC_NATIVE_WORKERS ?? "1",
  SCRIPTC_NATIVE_HOST_WORKERS: process.env.SCRIPTC_NATIVE_HOST_WORKERS ?? "1",
