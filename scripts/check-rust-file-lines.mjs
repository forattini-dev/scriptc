...
const legacyOversizedFiles = new Map([
  ...
  ["packages/compiler/src/frontend/lowering/lower-calls.ts", 9_244],
  ["packages/compiler/src/frontend/lowering/lower-classes.ts", 5_478],
  ...
  ["packages/compiler/src/ir/ir.ts", 7_509],
