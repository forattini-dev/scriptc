...
const legacyOversizedFiles = new Map([
  ...
  ["packages/compiler/src/frontend/lowering/lower-calls.ts", 9_048],
  ...
  ["packages/compiler/src/frontend/lowering/lower-exprs.ts", 10_882],
  ...
  ["packages/compiler/src/ir/validate.ts", 5_653],
