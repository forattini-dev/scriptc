...
const legacyOversizedFiles = new Map([
  ["packages/compiler/src/backend/cc.test.ts", 4_102],
  ["packages/compiler/src/backend/cc.ts", 6_039],
  ["packages/compiler/src/backend/emission/emit-async.ts", 1_279],
  ["packages/compiler/src/backend/emission/emit-exprs.ts", 7_929],
  ["packages/compiler/src/backend/emission/emit-walkers.ts", 2_058],
  ["packages/compiler/src/backend/emission/emitter.ts", 2_132],
  ["packages/compiler/src/backend/llvm/dyn.ts", 3_105],
  ["packages/compiler/src/backend/llvm/emitter.ts", 14_423],
  ["packages/compiler/src/frontend/lowering/lower-assert.ts", 1_492],
  ["packages/compiler/src/frontend/lowering/lower-builtins.ts", 8_025],
  ["packages/compiler/src/frontend/lowering/lower-calls.ts", 9_289],
  ["packages/compiler/src/frontend/lowering/lower-classes.ts", 5_525],
  ["packages/compiler/src/frontend/lowering/lower-containers.ts", 7_793],
  ["packages/compiler/src/frontend/lowering/lower-emitter.ts", 1_325],
  ["packages/compiler/src/frontend/lowering/lower-exprs.ts", 11_099],
  ["packages/compiler/src/frontend/lowering/lower-inspect.ts", 1_729],
  ["packages/compiler/src/frontend/lowering/lower-island.ts", 3_459],
  ...
  ["packages/compiler/src/frontend/lowering/lower-stmts.ts", 8_018],
  ["packages/compiler/src/frontend/lowering/lower-stream.ts", 1_876],
  ["packages/compiler/src/frontend/lowering/lowerer.ts", 9_331],
  ["packages/compiler/src/frontend/lowering/surfaces.ts", 1_781],
  ["packages/compiler/src/frontend/npm.ts", 2_007],
  ["packages/compiler/src/frontend/program.ts", 3_308],
  ["packages/compiler/src/frontend/types.ts", 3_982],
  ["packages/compiler/src/index.ts", 2_440],
  ["packages/compiler/src/ir/nodes.ts", 7_546],
  ["packages/compiler/src/ir/validate.ts", 5_672],
