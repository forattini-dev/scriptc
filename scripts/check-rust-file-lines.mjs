...
const legacyOversizedFiles = new Map([
  ["packages/compiler/src/backend/native-toolchain.test.ts", 3_964],
  ["packages/compiler/src/backend/native-toolchain.ts", 5_437],
  ["packages/compiler/src/backend/c/async.ts", 1_308],
  ["packages/compiler/src/backend/c/exprs.ts", 7_643],
  ["packages/compiler/src/backend/c/walkers.ts", 2_062],
  ["packages/compiler/src/backend/c/c-emitter.ts", 2_127],
  ["packages/compiler/src/backend/llvm/dyn.ts", 3_112],
  ...
  ["packages/compiler/src/frontend/lowering/lower-exprs.ts", 9_699],
  ["packages/compiler/src/frontend/lowering/lower-inspect.ts", 1_741],
  ["packages/compiler/src/frontend/lowering/lower-island.ts", 3_392],
  ["packages/compiler/src/frontend/lowering/lower-modules.ts", 2_088],
  ["packages/compiler/src/frontend/lowering/lower-server.ts", 4_813],
  ["packages/compiler/src/frontend/lowering/lower-stmts.ts", 8_299],
  ["packages/compiler/src/frontend/lowering/lower-stream.ts", 1_871],
  ["packages/compiler/src/frontend/lowering/lowerer.ts", 10_144],
  ["packages/compiler/src/frontend/lowering/surfaces.ts", 1_565],
  ["packages/compiler/src/frontend/npm.ts", 2_002],
  ["packages/compiler/src/frontend/program.ts", 3_333],
  ["packages/compiler/src/frontend/type-mapper.ts", 3_735],
